...
export default function NewSignUpDataTables() {
  let selected = [];
  const newSignUps = useTracker(() => MICMembers.find({ status: 'new' }).fetch());
        ...
        () => {
          ...
          Meteor.call(
            'sendEmail',
                ...
                'Proceed for Payment at MSMEIPOCHAMBERS',
                'Greetings! We have varified details of your Company,'+
                ' please pay Rs. 6000 and update Bank and Transaction Id at our website'
